  ...
  await prisma.vacante.createMany({
    data: [
      // Aprobadas (6)
      {
        ...
        area: 'Desarrollo Web',
        requisitos: 'React, Tailwind, REST APIs',
        estado: EstadoGeneral.APROBADA,
      ...
      },
      {
        ...
        requisitos: 'Node.js, PostgreSQL, Prisma',
        estado: EstadoGeneral.APROBADA,
        directorValidaId: director.id,
      },
      {
        ...
        area: 'Analítica',
        requisitos: 'SQL, Power BI, Python',
        estado: EstadoGeneral.APROBADA,
        directorValidaId: director.id,
      },
      {
        ...
        area: 'DevOps',
        requisitos: 'Docker, AWS, GitHub Actions',
        estado: EstadoGeneral.APROBADA,
        directorValidaId: director.id,
      },
      {
        ...
        requisitos: 'Flutter, Firebase, Clean Architecture',
        estado: EstadoGeneral.APROBADA,
        directorValidaId: director.id,
      },
      {
      ...
      // Pendientes (3)
      {
        ...
        area: 'Diseño',
        requisitos: 'Figma, UX Research, Design Systems',
        estado: EstadoGeneral.PENDIENTE,
      },
      {
        empresaId: empresa2.id,
        ...
        requisitos: 'Cypress, Jest, Postman',
        estado: EstadoGeneral.PENDIENTE,
      },
      {
        empresaId: empresa2.id,
        ...
        area: 'Soporte',
        requisitos: 'Linux, Redes, Atención al usuario',
        estado: EstadoGeneral.PENDIENTE,
      },
    ],
  });
